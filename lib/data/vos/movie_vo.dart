...
@JsonSerializable()
@HiveType(typeId: HIVE_TYPE_ID_MOVIEVO,adapterName: 'MovieVOAdapter')
class MovieVO {
...
String?status;
  ...
  String getGenreListAsCommaSepratedString(){
    return genres?.map((genres) => genres.name??"").toList().join(",")
??"";
  }
  String getProductionCountriesAsCommaSepratedString(){
